#ifndef LIGHTMAN_COMPOSITOR_H
#define LIGHTMAN_COMPOSITOR_H
...
public:
   ...
   */
  Layer *get_layer_by_name(const char *layer_name);
...
private:
  ...
  //    /**
  //     * Ambient threshold.
  //     * Noise threshold. This should get replaced by a bilateral filter.
  //     */
  //    float amb_diff;
