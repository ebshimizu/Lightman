...
string ToneMapper::get_type() {

    return type;

}

float ToneMapper::get_gamma() {

    return gamma;

}

void ToneMapper::set_gamma(float gamma) {

    this->gamma = gamma;

}

float ToneMapper::get_level() {

    return level;

}

void ToneMapper::set_level(float level) {
...
float TMReinhard::get_key() {

    return key;

}

void TMReinhard::set_key(float key) {

    this->key = key;

}

float TMReinhard::get_wht() {

    return wht;

}

void TMReinhard::set_wht(float wht) {
