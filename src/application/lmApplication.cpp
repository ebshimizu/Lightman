...
void Application::set_mode(Mode mode) {
    ...
    switch (mode) {
        ...
        case INTERACTIVE:
            ...
            break;
        case ANIMATION:
            if (animation) this->mode = ANIMATION;
            break;
        default:
            return;
    }
...
void Application::mouse_button_event(GLFWwindow* window,
...
void Application::cursor_pos_event(GLFWwindow* window,
...
void Application::scroll_event(GLFWwindow* window,
                               double xoffset, double yoffset) {
    // forward to tweakbar
    //TwEventMouseWheelGLFW(yoffset);
}

void Application::key_event(GLFWwindow* window,
                            int key, int scancode, int action, int mods) {
    // forward to tweakbar
    //TwEventKeyGLFW(key, action);
}

void Application::char_event(GLFWwindow* window,
                             unsigned int codepoint) {
    // forward to tweakbar?
    // TwEventCharGLFW() -> this still uses glfw2 definition
}

void Application::drop_event(GLFWwindow* window,
